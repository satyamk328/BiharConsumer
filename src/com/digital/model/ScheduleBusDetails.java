...
public class ScheduleBusDetails implements Serializable {
	...
	private List<CityStopMaster> boardingLocations = new ArrayList<>();
	private List<CityStopMaster> droppingLocations = new ArrayList<>();
	private List<CancelPolicies> cancellationPolicy = new ArrayList<>();
	
	private BusMaster busDetails = new BusMaster();
