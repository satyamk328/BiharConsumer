...
public class AmenitiesDao {
	...
	public List<BusAmenity> getAllAmenities() {
		...
		return jdbcTemplateObject.query(selectAllAminitiesQuery, new BusAmenitiesExtractor());
	}
	...
	public List<BusAmenity> getAmenitiesByBusId(Long busId) {
		...
		return jdbcTemplateObject.query(selectFilterAminitiesQuery, parameters, new BusAmenitiesExtractor());
	}
